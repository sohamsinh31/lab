...
import { FormRoutes } from '@/Providers/RouteProviders/FormRoutes';
...
const DefaultRoutes = () => {
    ...
    const currentPath = forms ? forms.toString() : 'dashboard'; // Ensure slug is a string

    const ActiveRoute = FormRoutes[currentPath] || null;
